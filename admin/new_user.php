            ...
            <?php if ($_SESSION['login_type'] == 1) : ?>
              <div class="form-group">
                ...
                <select name="type" id="type" class="custom-select custom-select-sm">
                  <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Miembro ong</option>
                  <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>------</option>
          ...
          <div class="col-md-6">
            ...
            <?php if (!isset($id)) : ?>
              <div class="form-group">
                ...
                <!-- <small><i>Dejar en blanco si no deseas cambiar la contraseña</i></small> -->
              </div>
              <div class="form-group">
